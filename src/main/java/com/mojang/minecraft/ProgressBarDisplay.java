...
condition|)
block|{
comment|//downloadSkin(minecraft);
comment|//minecraft.textureManager.textures.clear();
block|}
block|}
else|else
return|return
...
name|println
argument_list|(
literal|"Changing water level to "
operator|+
name|i1
argument_list|)
expr_stmt|;
...
name|println
argument_list|(
literal|"Changing fog colour to "
operator|+
name|i1
argument_list|)
expr_stmt|;
...
name|println
argument_list|(
literal|"Changing sky colour to "
operator|+
name|i1
argument_list|)
expr_stmt|;
...
name|println
argument_list|(
literal|"Changing cloud colour to "
operator|+
name|i1
argument_list|)
expr_stmt|;
