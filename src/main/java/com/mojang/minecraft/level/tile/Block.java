...
literal|0.6F
decl_stmt|;
comment|// Lava should be equally bright from all sides.
if|if
condition|(
name|this
operator|.
...
name|brightness
decl_stmt|;
comment|// Renders the bottom side of the block.
if|if
condition|(
name|this
operator|.
...
expr_stmt|;
block|}
comment|// Renders the top side of the block.
if|if
condition|(
name|this
operator|.
