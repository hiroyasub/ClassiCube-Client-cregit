...
name|format
argument_list|(
literal|"Could not download skin for \"%s\". Server at %s returned code %s"
argument_list|,
name|skinName
argument_list|,
name|skinServer
...
name|format
argument_list|(
literal|"Network error while downloading skin for \"%s\" from %s: %s"
argument_list|,
name|skinName
argument_list|,
name|skinServer
...
name|format
argument_list|(
literal|"Unexpected error while downloading skin for \"%s\" from %s: %s"
argument_list|,
name|skinName
argument_list|,
name|skinServer
