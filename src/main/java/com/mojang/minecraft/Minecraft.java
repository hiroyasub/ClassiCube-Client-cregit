...
name|println
argument_list|(
literal|"Adding ExtEntry to list"
argument_list|)
expr_stmt|;
name|com
operator|.
...
name|println
argument_list|(
literal|"ExtEntry has reached total length"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"Making temp array data"
argument_list|)
expr_stmt|;
name|List
argument_list|<
...
name|println
argument_list|(
literal|"Adding ExtEntry to packet to send:"
operator|+
name|PacketType
operator|.
name|packets
...
name|println
argument_list|(
literal|"Sending my ExtList inside a loop, one by one"
argument_list|)
expr_stmt|;
name|networkManager
operator|.
...
argument_list|()
decl_stmt|;
comment|//byte[] toSendParams = new byte[] { com.oyasunadev.mcraft.client.util.Constants.SupportLevel };
name|networkManager
operator|.
name|netHandler
operator|.
...
expr_stmt|;
block|}
comment|// ===============KICK if packetType is not mutual================
comment|//if(com.oyasunadev.mcraft.client.util.Constants.ServerSupportedExtensions
comment|//.contains(new ExtData(
comment|//	packetType.extName,
comment|//packetType.Version)))
block|{
comment|/* else if (packetType == PacketType.ENV_SET_COLOR) { 														byte Variable = ((Byte) packetParams[0]) 																.byteValue(); 														byte r = ((Byte) packetParams[1]) 																.byteValue(); 														byte g = ((Byte) packetParams[2]) 																.byteValue(); 														byte b = ((Byte) packetParams[3]) 																.byteValue(); 														int dec = 256 * 256 * r + 256 * g + b; 														switch (Variable) { 														case 0: // sky 															this.level.skyColor = dec; 															break; 														case 1: // cloud 															this.level.cloudColor = dec; 															break; 														case 2: // fog 															this.level.fogColor = dec; 															break; 														case 3: // ambient light 																// (TODO) 															this.level.customShadowColour = new ColorCache( 																	r / 255.0F, g / 255.0F, 																	b / 255.0F); 															break; 														case 4: // diffuse color 																// (TODO) 															this.level.customLightColour = new ColorCache( 																	r / 255.0F, g / 255.0F, 																	b / 255.0F); 															break; 														} 														this.levelRenderer.refresh(); 													} else if (packetType == PacketType.CLICK_DISTANCE) { 														short Distance = (Short) packetParams[0]; 														this.gamemode.reachDistance = Distance / 32; 													} else if (packetType == PacketType.HOLDTHIS) { 														byte BlockToHold = ((Byte) packetParams[0]) 																.byteValue(); 														byte PreventChange = ((Byte) packetParams[1]) 																.byteValue(); 														boolean CanPreventChange = PreventChange> 0;  														if (CanPreventChange == true) 															GameSettings.CanReplaceSlot = false;  														this.player.inventory.selected = 0; 														this.player.inventory 																.replaceSlot(Block.blocks[BlockToHold]);  														if (CanPreventChange == false) 															GameSettings.CanReplaceSlot = true; 													} else if (packetType == PacketType.SET_TEXT_HOTKEY) { 														String Label = (String) packetParams[0]; 														String Action = (String) packetParams[1]; 														int keyCode = (Integer) packetParams[2]; 														byte KeyMods = ((Byte) packetParams[3]) 																.byteValue(); 													} else if (packetType == PacketType.EXT_ADD_ENTITY) { 														byte playerID = ((Byte) packetParams[0]) 																.byteValue(); 														String playerName = (String) packetParams[1]; 														String listName = (String) packetParams[2]; 														String groupName = (String) packetParams[3]; 														byte unusedRank = ((Byte) packetParams[4]) 																.byteValue(); 													} else if (packetType == PacketType.EXT_ADD_ENTITY) { 														byte playerID = ((Byte) packetParams[0]) 																.byteValue(); 														String playerName = (String) packetParams[1]; 														String skinName = (String) packetParams[2];  														NetworkPlayer player = networkManager.players 																.get(playerID); 														if (player != null) { 															player.SkinName = skinName; 															((NetworkPlayer) player) 																	.downloadSkin(); 														} 													} else if (packetType == PacketType.EXT_REMOVE_PLAYER_NAME) { 														String playerName = (String) packetParams[0]; 													}*/
block|}
block|}
block|}
block|}
...
argument_list|()
expr_stmt|;
comment|//this.level.customLightColour = new
comment|//ColorCache(1/255F, 120/255F, 120/255F);
comment|//this.level.customShadowColour = new
comment|// ColorCache(120/255F, 1/255F, 120/255F);
