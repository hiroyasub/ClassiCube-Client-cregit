...
argument_list|()
expr_stmt|;
comment|//System.setProperty("org.lwjgl.librarypath", mcDir + "/native/windows");
comment|//System.setProperty("net.java.games.input.librarypath", mcDir + "/native/windows");
if|if
condition|(
name|this
operator|.
