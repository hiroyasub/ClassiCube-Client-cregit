...
literal|1
decl_stmt|;
comment|// to store controller number of the gamepad
try|try
block|{
name|System
operator|.
...
name|println
argument_list|(
literal|"No gamepad controller exists."
argument_list|)
expr_stmt|;
block|}
else|else
...
argument_list|)
expr_stmt|;
comment|// for (int i = 0; i< bc; i++) {
comment|// System.out.println(c[gp].getButtonName(i));
comment|// }
block|}
block|}
block|}
