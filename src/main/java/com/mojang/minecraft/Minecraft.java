...
name|cursor
decl_stmt|;
comment|/**      * Creates a new Minecraft instance.      *      * @param canvas Canvas to use for drawing.      * @param applet applet of this instance      * @param fullscreen True if game should be in fullscreen      * @param isApplet True if the game is running as an applet      */
specifier|public
name|Minecraft
parameter_list|(
name|Canvas
