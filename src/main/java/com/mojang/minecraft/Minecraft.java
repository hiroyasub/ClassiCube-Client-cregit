...
name|timeBeforeChunkUpdates
decl_stmt|;
comment|// Adjust measured average-time-per-chunk-update
name|timer
operator|.
name|chunkUpdateTime
operator|=
...
literal|0.5
expr_stmt|;
comment|// Next frame, use up to 90% of available CPU time for chunks
name|Renderer
operator|.
name|dynamicChunkUpdateLimit
operator|=
