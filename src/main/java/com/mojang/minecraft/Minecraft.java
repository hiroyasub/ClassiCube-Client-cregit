...
comment|// 20, 30, 40)));
comment|/*for(int i = 0; i< 140; i++){ 	    String group = "Guest"; 	    if(i> 8)group = "Owner"; 	    if(i> 11) group = "Test"; 	    if( i> 18) group = "Test2"; 	    if(i> 32) group = "Last group"; 	    if(i> 35) group = "jk"; 	    if(i> 40) group = "rollin"; 	    if(i> 45) group = "aaaaa"; 	    this.playerListNameData.add(new PlayerListNameData((short) i, "" +i, "" +i, group, (byte)1)); 	     	}*/
name|this
operator|.
name|isApplet
operator|=
