...
argument_list|()
expr_stmt|;
comment|// TODO Determine if this is really needed. Can't we reuse variables from earlier?
name|var34
operator|=
operator|(
name|levelRenderer
...
literal|255F
expr_stmt|;
comment|//shapeRenderer.color(skyColorRed, skyColorBlue, skyColorGreen);
name|shapeRenderer
operator|.
name|color
argument_list|(
