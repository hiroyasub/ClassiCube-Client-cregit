...
block|}
block|}
comment|// return true if keep going; return false is break;
specifier|private
name|boolean
name|handlePacket
parameter_list|(
...
name|logWarning
argument_list|(
literal|"Minecraft.handlePacket: Unknown block ID given for SetBlockPermission packet: "
operator|+
name|blockType
argument_list|)
expr_stmt|;
