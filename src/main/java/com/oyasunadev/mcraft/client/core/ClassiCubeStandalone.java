...
argument_list|)
expr_stmt|;
comment|/*String s = System.getProperty("os.name").toLowerCase(); 		System.setProperty("org.lwjgl.librarypath", minecraft.getMinecraftDirectory() + "/native/" 			+ minecraft.getOSfolderName(s)); 		System.setProperty("net.java.games.input.librarypath", minecraft.getMinecraftDirectory() 			+ "/native/" + minecraft.getOSfolderName(s)); */
name|minecraft
operator|.
name|session
operator|=
